            ...
            <div class="col-sm-12">
              <div class="home-tab">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    <li class="nav-item">
                      <a class="nav-link" id="main-tab" data-bs-toggle="tab" href="#" role="tab" aria-selected="false">Panel de Inventario</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" id="main-tab" data-bs-toggle="tab" href="#" role="tab" aria-selected="false">Lista de Items</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" id="material-list-tab" data-bs-toggle="tab" href="#" role="tab" aria-selected="false">Crear Items</a>
                    </li>
                  </ul>
                </div>
                      ...
                      <div class="col-lg-10 d-flex flex-column">
                        <div class="row flex-grow">
                          <div class="col-12 grid-margin stretch-card">
                            <div class="card card-rounded">
                              <div class="card-body">
                                <h2 class="card-title">Registrar un Item</h2>
                                <p class="card-description"> Agregue un Item</p>
                                <form class="forms-sample">
                                  ...
                                  <div class="form-group">
                                     <button type="submit" class="btn btn-lg btn-success text-light">Registrar Item</button>
                                  </div>
                                </form>
                              </div>
                            </div>
