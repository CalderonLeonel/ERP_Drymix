                          ...
                          <div class="col-12 grid-margin stretch-card">
                            <div class="card card-rounded">
                              <div class="card-body">
                                <div class="d-sm-flex justify-content-between align-items-start">
                                  <div>
                                    <h4 class="card-title card-title-dash">Listado de Secciones</h4>
                                  </div>
                                </div>
                                ...
                                <table class="table select-table">
                                    ...
                                    <?php foreach($table as $row):?>
                                      <tr>
                                        <td>
                                          <h6><?php echo $row['idStand'];?></h6>
                                        </td>
                                        <td>
                                          <h6><?php echo $row['standName'];?></h6>                                        
                                        </td>
                                        <td>
                                          <h6><?php echo $row['idSection'];?></h6>
                                        </td>
                                        <td>
                                          <form method="post" action="<?php echo site_url('StorageManagementController/editStand')?>">
                                            <div class="form-group">
                                              <input type="hidden" name="idStand" id="idStand" value="<?php echo $row['idStand'];?>">
                                              <input type="submit" class="btn btn-primary" value="Editar">
                                            </div>
                                          </form>   
                                          <form method="post" action="<?php echo site_url('StorageManagementController/DeleteStand')?>">
                                            <div class="form-group">
                                            <input type="hidden" name="idStand" id="idStand"  value="<?php echo $row['idStand'];?>">
