                      ...
                      <div class="col-lg-10 d-flex flex-column">
                        <div class="row flex-grow">
                          <div class="col-12 grid-margin stretch-card">
                            <div class="card card-rounded">
                              <div class="card-body">
                                <h2 class="card-title">Registrar un Stand</h2>
                                <p class="card-description"> Agregue un Stand para Guardar Items</p>
                                <form class="forms-sample" method="POST" action="<?php echo site_url('StorageManagementController/InsertStand')?>">
                                  <div class="form-group">
                                   <label for="standName">Nombre De Stand</label>
                                   <input type="text" class="form-control" id="standName" name="standName" placeholder="Nombre de Stand">
                                  </div>
                                  <div class="form-group">
                                       <label for="idSection">Seccion</label>
                                       <select class="form-control" id="idSection" name="idSection">
                                       <?php foreach ($list2 as $row2)
                                       {
                                        ?>
                                        <option value="<?php echo $row2['idSection']?>"><?php echo $row2['sectionName'];?></option>                                
                                       <?php
                                       }
                                       ?>
                                     </select>
                                  ...
                                  <div class="form-group">
                                     <button type="submit" class="btn btn-lg btn-success text-light">Registrar Stand</button>
                                  </div>
                                </form>
                              </div>
                            </div>
