                          ...
                          <div class="col-12 grid-margin stretch-card">
                            <div class="card card-rounded">
                              <div class="card-body">
                                ...
                                <form class="forms-sample" method="POST" action="<?php echo site_url('StorageManagementController/UpdateStand')?>">
                                <?php foreach($table as $row):?>
                                  <input type="hidden" name="idStand" value="<?php echo $row['idStand'];?>">
                                  <div class="form-group">
                                   <label for="standName">Nombre De Stand</label>
                                   <input type="text" class="form-control" id="standName" name="standName" value="<?php echo $row['standName'];?>" placeholder="Nombre de Stand">
                                  </div>                
                                  <div class="form-group">
                                     <button type="submit" class="btn btn-lg btn-success text-light">Modificar Stand</button>
                                  </div>
                                  <?php endforeach;?>
                                </form>
                              </div>
