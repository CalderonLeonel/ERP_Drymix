                                  ...
                                  <table class="table select-table">
                                    ...
                                    <?php foreach($data as $row):?>
                                      <tr>
                                        ...
                                        <td>
                                          <form method="post" action="<?php echo site_url('StorageManagementController/editItemType')?>">
                                            <div class="form-group">
                                            <input type="hidden" name="idItemType" value="<?php echo $row['idItemType'];?>">
                                              <input type="submit" class="btn btn-primary" value="Editar">
                                            </div>
                                          </form>   
                                          <form method="post" action="<?php echo site_url('StorageManagementController/DeleteItemType')?>">
                                            <div class="form-group">
                                            <input type="hidden" name="idItemType" value="<?php echo $row['idItemType'];?>">
