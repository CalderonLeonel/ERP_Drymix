                          ...
                          <div class="col-12 grid-margin stretch-card">
                            <div class="card card-rounded">
                              <div class="card-body">
                                ...
                                <form class="forms-sample" method="POST" action="<?php echo site_url('StorageManagementController/UpdateStorage')?>">
                                <?php foreach($data as $row):?>
                                  <div class="form-group">
                                  <input type="hidden" name="idStorage" value="<?php echo $row['idStorage'];?>">
                                   <label for="storageName">Nombre De almacen</label>
                                   <input type="text" class="form-control" id="storageName" name="storageName" value="<?php echo $row['storageName'];?>" placeholder="Nombre de Almacen">
                                  </div>
                                  <div class="form-group">
                                     <button type="submit" class="btn btn-lg btn-success text-light">Modificar Almacen</button>
                                  </div>
                                <?php endforeach;?>
                                </form>
                              </div>
