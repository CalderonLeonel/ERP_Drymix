                              ...
                              <div class="card-body">
                                ...
                                <form class="forms-sample" method="POST" action="<?php echo site_url('StorageManagementController/InsertItem')?>">
                                  ...
                                  <div class="form-group">
                                   ...
                                   <input type="text" class="form-control" id="itemName" name="itemName" placeholder="Nombre Item">
                                  </div>
                                  <div class="form-group">
                                       ...
                                       {
                                        ?>
                                        <option value="<?php echo $row['idItemType'];?>"><?php echo $row['itemTypeName'];?></option>                                
                                       <?php
                                       }
                                       ?>
                                       </select>
