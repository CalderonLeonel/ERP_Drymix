                                  ...
                                  <table class="table select-table">
                                    ...
                                    <?php foreach($table as $row):?>
                                      <tr>
                                        ...
                                        <td>
                                          <form method="post" action="<?php echo site_url('StorageManagementController/editItem')?>">
                                            <div class="form-group">
                                              <input type="hidden" name="idItem" value="<?php echo $row['idItem'];?>">
                                              <input type="submit" class="btn btn-primary" value="Editar">
                                            </div>
                                          </form>   
                                          <form method="post" action="<?php echo site_url('StorageManagementController/DeleteItem')?>">
                                            <div class="form-group">
                                            <input type="hidden" name="idItem" value="<?php echo $row['idItem'];?>">
