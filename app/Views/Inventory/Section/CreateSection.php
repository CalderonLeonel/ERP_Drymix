                          ...
                          <div class="col-12 grid-margin stretch-card">
                            <div class="card card-rounded">
                              <div class="card-body">
                                ...
                                <p class="card-description"> Agregue una Seccion para Guardar Items</p>
                                <form class="forms-sample" method="POST" action="<?php echo site_url('StorageManagementController/InsertSection')?>">
                                  <div class="form-group">
                                   <label for="sectionName">Nombre De Sección</label>
                                  ...
                                  <div class="form-group">
                                     <button type="submit" class="btn btn-lg btn-success text-light">Registrar Sección</button>
                                  </div>
                                </form>
                              </div>
                            </div>
