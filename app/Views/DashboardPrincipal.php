...
<head>
  ...
  <title>Admin</title>
  <!-- plugins:css -->
  <link rel="stylesheet" href="<?php echo base_url()?>/svendors/feather/feather.css">
...
>>>>>>> 634a1621d6fb398abc6df491f241fdc550daf023
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="editors">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"><a class="nav-link" href="<?php echo base_url("produccion")?>">Inicio</a></li>
              </ul>
            </div>
            <div class="collapse" id="editors">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"><a class="nav-link" href="<?php echo base_url("Products/create")?>">Nuevo Producto</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
