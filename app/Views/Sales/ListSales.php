<div class="content-wrapper">
    <div class="card">
        <div class="card-body">
            <h4 class="card-title">Movimiento de Saleo de la Empresa</h4>
            <td>
                <form method="POST" action="<?php echo base_url('SaleController/NewSale') ?>">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                <button class="btn btn-info" id="btnInfo<?php echo $row->idSale ?>" data-bs-toggle="modal" data-bs-target="#infoSale">
                                                    <i class="mdi mdi-information-outline"></i>
                                                </button>

                                                <form method="POST" action="<?php echo base_url('SaleController/Update') ?>">
                                                    <input type="hidden" value="<?php echo $row->idSale ?>" id="idSale" name="idSale">
                                                    <button class="btn btn-success" id="btnEdit">
                                                        <i class="mdi mdi-tooltip-edit"></i>
                                                    </button>
                                                </form>

                                                <button class="btn btn-danger" onclick="MDelSale(<?php echo $row->idSale; ?>)">
