            ...
            <div class="col-sm-12">
              <div class="home-tab">
                ...
                <ul class="nav nav-tabs" role="tablist">
                   <li class="nav-item">
                      <a class="nav-link active" id="main-tab" data-bs-toggle="tab" href="<?php echo base_url('AcquisitionController/list')?>" role="tab" aria-selected="false">Lista de Adquisiciones</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                      <a class="nav-link" id="material-list-tab" data-bs-toggle="tab" href="<?php echo base_url('AcquisitionController/create')?>" role="tab" aria-selected="true">Crear Adquisicion</a>
                    </li>
                  </ul>
                </div>
