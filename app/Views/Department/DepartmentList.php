                                ...
                                <div class="table-responsive  mt-1">
                                  <table class="table select-table">
                                    ...
                                    <?php foreach($table as $data):?>
                                        ...
                                        <td>
                                          <form method="post" action="<?php echo site_url('DepartmentController/editDepartment')?>" >
                                            <div class="form-group">
                                              <input type="hidden" name="idDepartment" id="idDepartment" value="<?= $data['idDepartment'];?>">
                                              <input type="submit" class="btn btn-primary text-light" value="Editar">
                                            </div>
                                          </form>   
                                          <form method="post" action="<?php echo site_url('DepartmentController/DeleteDepartment')?>" >
                                            <div class="form-group">
                                            <input type="hidden" name="idDepartment" id="idDepartment" value="<?= $data['idDepartment'];?>">
