            ...
            <div class="col-sm-12">
              <div class="home-tab">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    <li class="nav-item">
                      <a class="nav-link" id="main-tab" data-bs-toggle="tab" href="<?php echo base_url('DepartmentController/list')?>" role="tab" aria-selected="false">Lista de Departamentos</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                      <a class="nav-link active" id="material-list-tab" data-bs-toggle="tab" href="<?php echo base_url('DepartmentController/create')?>" role="tab" aria-selected="true">Crear Departamentos</a>
                    </li>
                  </ul>
                </div>
                      ...
                      <div class="col-lg-10 d-flex flex-column">
                        <div class="row flex-grow">
                          <div class="col-12 grid-margin stretch-card">
                            <div class="card card-rounded">
                              <div class="card-body">
                                <h2 class="card-title">Registrar un departamento</h2>
                                <p class="card-description"> Agregue un departamento para asignar a los empleados</p>
                                <form class="forms-sample" method="POST" id="add_department" name="add_department" action="<?php echo site_url('departmentController/Insertdepartment')?>">
                                  <div class="form-group">
                                   <label for="departmentName">Nombre Del departamento</label>
                                   <input type="text" class="form-control" id="departmentName" name="departmentName" placeholder="Nombre departamento">
                                  </div>
                                  <div class="form-group">
                                     <button type="submit" class="btn btn-lg btn-success text-light">Registrar departamento</button>
                                  </div>
                                </form>
                              </div>
                            </div>
