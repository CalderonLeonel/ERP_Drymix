              ...
              <div class="home-tab">
                <div class="d-sm-flex align-items-center justify-content-between border-bottom">
                  <ul class="nav nav-tabs" role="tablist">
                    <li class="nav-item">
                      <a class="nav-link active" id="main-tab" data-bs-toggle="tab" href="<?php echo base_url('DepartmentController/index')?>" role="tab" aria-selected="false">Panel de Departamentos</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                      <a class="nav-link" id="material-list-tab" data-bs-toggle="tab" href="<?php echo base_url('DepartmentController/create')?>" role="tab" aria-selected="true">Crear Departamentos</a>
                    </li>
                  </ul>
                </div>
                          ...
                          <div class="col-12 grid-margin stretch-card">
                            <div class="card card-rounded">
                              <div class="card-body">
                                <div class="d-sm-flex justify-content-between align-items-start">
                                  <div>
                                    <h4 class="card-title card-title-dash">Listado de Departamentos</h4>
                                  </div>
                                  <div>
                                  <a href="DepartmentController/List"  class="btn btn-primary btn-lg text-white mb-0 me-0"><i class="mdi mdi-playlist-plus"></i>Ver Listado Completo</a>
                                  </div>
                                </div>
                                <div class="table-responsive  mt-1">
                                  <table class="table select-table">
                                    ...
                                    <?php foreach(array_slice($table , 0, 5)as $data):?>
                                        <td>
                                          <h6><?= $data['idDepartment'];?></h6>
                                        </td>
                                        <td>
                                          <h6><?= $data['departmentName'];?></h6>                                        
                                        </td>
                                      </tr>
                                    <?php endforeach;?>
                                    </tbody>
