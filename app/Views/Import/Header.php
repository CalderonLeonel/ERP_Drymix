      ...
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-start">
        ...
        <div>
          <a class="navbar-brand brand-logo" href="DashboardPrincipal.php ">
            <img src="../public/images/Drymix.png" width="200px" height="200px" alt="logo" />
          </a>
        </div>
      </div>
        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="editors">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo base_url("ProductsController/RegisterProduct")?>">Nuevo Producto</a>
                 </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo base_url("ProductsController/ListProducts")?>">Lista de Productos</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo base_url("ProductTypeController/ListTypes")?>">Tipos de Productos</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo base_url("LinesController/ListLines")?>">Tipos de Lineas</a>
                </li>
              </ul>
            </div>
          </li>
