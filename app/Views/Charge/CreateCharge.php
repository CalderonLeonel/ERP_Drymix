                      ...
                      <div class="col-lg-10 d-flex flex-column">
                        <div class="row flex-grow">
                          <div class="col-12 grid-margin stretch-card">
                            <div class="card card-rounded">
                              <div class="card-body">
                                <h2 class="card-title">Registrar un Cargo</h2>
                                <p class="card-description"> Agregue un Cargo</p>
                                <form class="forms-sample" method="POST" action="<?php echo site_url('StorageManagementController/InsertItem')?>">
                               
                                  <div class="form-group">
                                   <label for="ChargeName">Nombre De Cargo</label>
                                   <input type="text" class="form-control" id="ChargeName" name="ChargeName" placeholder="Nombre Cargo">
                                  </div>
                                  <div class="form-group">
                                       ...
                                       {
                                        ?>
                                        <option value="<?php echo $row['idDepartamento'];?>"><?php echo $row['DepartamentName'];?></option>                                
                                       <?php
                                       }
                                       ?>
                                       </select>
                                  ...
                                  <div class="form-group">
                                     <button type="submit" class="btn btn-lg btn-success text-light">Registrar Cargo</button>
                                  </div>
